...
/** ITU dial codes — India first (default), then alphabetical by country name. */
...
export const defaultCountryDial = "91";

export const countryDialCodes = new Set(countryCodes.map((c) => c.dial));
